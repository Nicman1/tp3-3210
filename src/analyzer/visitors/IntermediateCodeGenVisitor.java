...
public class IntermediateCodeGenVisitor implements ParserVisitor {
    ...
    public Object visit(ASTIfStmt node, Object data) {
        ...
        if (hasElse) {
            ...
            BoolLabel bl = new BoolLabel(newLabel(), sNext);
            condNode.jjtAccept(this, bl);
            label(bl.lTrue);
            thenNode.jjtAccept(this, sNext);
        }
    ...
    public Object visit(ASTWhileStmt node, Object data) {
        ...
        BoolLabel bLabels = new BoolLabel(newLabel(), sNext);
    ...
    public Object visit(ASTNotExpr node, Object data) {
        if (data instanceof BoolLabel) {
            BoolLabel bLabels = (BoolLabel) data;
            node.jjtGetChild(0).jjtAccept(this, bLabels.swapped());
        }
        return null;
    }
